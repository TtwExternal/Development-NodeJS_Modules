//----------------------------------------------------------------------------------------------------;
var fileNm = "/js/b2link_router/_query/find/getSelectorList__SearchKeyword.js";
 ...
 * @property {String}
 */
var _query = global.b2link.fs.getDBJS( "../../../Development-NodeJS_Modules/js/b2link_router/_query/find/getSelectorList__SearchKeyword.dbjs" );
 ...
 * @example
 * <code>
	http://localhost:49320/_query/find/getSelectorList__SearchKeyword
	http://localhost:49320/_query/find/getSelectorList__SearchKeyword?
 * </code>
 */
(function( req, res ){
	global.TtwLog.log( "- [ S ] - _query/find/getSelectorList__SearchKeyword():void----------" );
	...
	var query = _query.replace( "<!=nm_db=!>", q.nm_db ).replace( "<!=nm_col=!>", q.nm_col )
		...
		.replace( "<!=data=!>", q.data );
		query = q.limit ? query.replace( "<!=limit=!>", q.limit ) : query.replace( ".limit( <!=limit=!> )", "" );
		query = q.skip  ? query.replace( "<!=skip=!>" , q.skip )  : query.replace( ".skip( <!=skip=!> )"  , "" );
	...
	global.TtwLog.log( "- [ E ] - _query/find/getSelectorList__SearchKeyword():void----------" );
});