//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui/test/window.b2link_ui.test.search_selector.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui.test.search_selector():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui.test.search_selector():{Array}----------" );
	return o;
};
