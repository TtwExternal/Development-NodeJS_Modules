//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui/test/window.b2link_ui.test.select__db__values.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui.test.select__db__values():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui.test.select__db__values():{Array}----------" );
	return o;
};
