//----------------------------------------------------------------------------------------------------;
var fileNm = "js/b2link_ui/test/window.b2link_ui.test.list__b2link_service.js";
...
{
	window.TtwLog.timeStamp( "---- [ S ] - window.b2link_ui.test.list__b2link_service():{Array}----------" );
	...
	window.TtwLog.timeStamp( "---- [ E ] - window.b2link_ui.test.list__b2link_service():{Array}----------" );
	return o;
};
